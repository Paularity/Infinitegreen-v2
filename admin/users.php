            ...
            <div class="card-body">
                <table class="table-striped table-bordered col-md-12">
                    ...
                    <tbody>
 					...
 					$users = $conn->query("SELECT * FROM user_info order by last_name asc");
 					$i = 1;
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item edit_user" href="javascript:void(0)"
                                                data-id='<?php echo $row['user_id'] ?>'>Edit</a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item delete_user" href="javascript:void(0)"
                                                data-id='<?php echo $row['user_id'] ?>'>Delete</a>
                                        </div>
                                    </div>
                                </center>
                            </td>
...
$('.edit_user').click(function() {
    uni_modal('Edit User', 'manage_user.php?user_id=' + $(this).attr('data-id'))
})
