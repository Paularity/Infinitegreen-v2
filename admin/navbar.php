...
<nav id="sidebar" class='mx-lt-5 bg-dark'>
    ...
    <div class="sidebar-list">
        ...
        <a href="index.php?page=transactions" class="nav-item nav-transactions"><span class='icon-field'><i
                    class="fa fa-th-list"></i></span> Transactions</a>
        ...
        <a href="index.php?page=categories" class="nav-item nav-categories"><span class='icon-field'><i
                    class="fa fa-th-list"></i></span> Categories</a>
        <a href="index.php?page=brands" class="nav-item nav-brands"><span class='icon-field'><i
                    class="fa fa-th-list"></i></span> Brands</a>
        ...
        <a href="index.php?page=sellers" class="nav-item nav-sellers"><span class='icon-field'><i
                    class="fa fa-users"></i></span> Admin/Sellers</a>
