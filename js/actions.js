	...
	*/
	...
	$("body").delegate("#btn-gcash","click",function(event){
		...
		$.ajax({
			url	:	"action.php",
			method	:	"POST",
			data	:	{updatePaymentMethod:1,payment_method:'gcash'},
			success	:	function(data){
				console.log(data);
				// $("#cart_msg").html(data);
				// checkOutDetails();
	...
	$("body").delegate("#btn-cod","click",function(event){
		...
		$.ajax({
			url	:	"action.php",
			method	:	"POST",
			data	:	{updatePaymentMethod:1,payment_method:'cod'},
			success	:	function(data){
				console.log(data);
				// $("#cart_msg").html(data);
				// checkOutDetails();
	...
	$("body").delegate("#btn-card","click",function(event){
		...
		$.ajax({
			url	:	"action.php",
			method	:	"POST",
			data	:	{updatePaymentMethod:1,payment_method:'card'},
			success	:	function(data){
				console.log(data);
				// $("#cart_msg").html(data);
				// checkOutDetails();
	...
	$("body").delegate("#gcash-checkout","submit",function(event){
		event.preventDefault()
		...
		$.ajax({
			url	:	"action.php",
			method	:	"POST",
			data	:	{checkoutGcash:1,accountNumber: accountNumber, total: total},
			success	:	function(data){			
				location.href = data;
			}
		})
	})
	$("body").delegate("#send-message","submit",function(event){
		event.preventDefault();
		var msg = event.target[2].value;		
		$.ajax({
			url	:	"action.php",
			method	:	"POST",
			data	:	{sendMessage:1,msg: msg},
			success	:	function(data){			
				// console.log(data);
				location.href = 'manage_messages.php?id=1';
			}
		})
	})
