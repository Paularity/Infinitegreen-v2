...
<html lang="en">
	<head>
		...
		<title>Infinitegreen: Store</title>
			...
			<div id="top-header">
				<div class="container">					
					<ul class="header-links pull-right">
						...
						<li>
							<a href="store.php"><i class="fa fa-shopping-bag"></i> Store</a>
						</li>
						<li>
							<a href="http://localhost/infinitegreen-v2-auction"><i class="fa fa-dollar"></i> Auction</a>
						</li>
						<li><?php
                             include "db.php";
					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="header-logo" style=" margin-top: 10px;">
								...
								<font style="font-size: 33px;color: aliceblue;">
                                        Infinitegreen
                                    </font>
							...
							<div class="col-md-6">
								<div class="header-search">
									<form>
										...
										<input class="input" id="search" type="text" placeholder="Search here" value="">
